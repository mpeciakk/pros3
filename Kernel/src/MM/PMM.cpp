...
PhysicalMemoryManager::PhysicalMemoryManager(u32 memoryMap, u32 memorySize) {
    ...
    // TODO: not sure if it's right :think:
    memset(this->memoryMap, 0xFF, maxBlocks / BLOCKS_PER_BYTE);
}

void PhysicalMemoryManager::setRegionFree(u32 start, u32 size) {
...
void PhysicalMemoryManager::setRegionUsed(u32 start, u32 size) {
    int align = start / BLOCK_SIZE;
    int blocks = size / BLOCK_SIZE;
